...
test('getAllNotificationsByUser returns correct user notifications', () => {
  ...
  expect(getAllNotificationsByUser(testUserID)).toEqual(
    expect.arrayContaining(expectedNotifications)
  );
});

describe('Normalized notifications', () => {
  test('has hte right results entry', () => {
  ...
  test('has correct user output for 5debd764a7c57c7839d722e9', () => {
  ...
  test('Correct meessage info for id efb6c485-00f7-4fdf-97cc-5e12d14d6c41', () => {
    const expectedMessageInfo = {
    ...
    ).toEqual(expectedMessageInfo);
  });

  test('Has correct notification out for id 5debd7642e815cd350407777', () => {
    const expectedNotificationoutput = {
    ...
    ).toEqual(expectedNotificationoutput);
  });
});
